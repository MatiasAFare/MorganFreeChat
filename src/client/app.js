class ChatApp {
    ...
    setupWebSocketEvents() {
        ...
        wsClient.on('chat_message', (data) => {
            const content = data.encrypted ? clientCrypto.decrypt(data.content) : data.content;
    ...
    async handleRegister() {
        ...
        try {
            ...
            if (result.success) {
                this.showModal('¡Registro exitoso!', 'Tu cuenta ha sido creada. Ahora puedes iniciar sesión.');
                this.showLoginForm();
    ...
    showModal(title, message) {
        ...
        document.getElementById('modal-body').innerHTML = `<p>${this.escapeHtml(message)}</p>`;
    ...
    checkStoredCredentials() {
        ...
        const intentionalDisconnect = localStorage.getItem('morgan_chat_intentional_disconnect');
